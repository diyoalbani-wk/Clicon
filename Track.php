...
<section class="hidden md:flex py-4 bg-gray-100">
    <div class="flex gap-2 container mx-auto">
        ...
        <div class="flex text-gray-500 items-center active:text-blue-500">
            Track Order 
        </div>
    </div>
</section>
...
<section class="container mx-auto px-4 md:px-0 grid grid-cols-1 md:grid-cols-2">
    <div class="space-y-4 py-12 mb-12 col-span-1 px-0 md:px-0">
        ...
        <button class="flex-2 bg-orange-500 text-white rounded font-semibold flex items-center justify-center gap-2 p-2 px-4">
            <a href="Order_detail.php" class="flex">
                TRACK ORDER
