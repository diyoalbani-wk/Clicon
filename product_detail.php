...
<!-- START CONTENT -->
<?php
include __DIR__ . '/template/section/productdetail/detail.php';
include __DIR__ . '/template/section/productdetail/descripsi.php';
include __DIR__ . '/template/section/productdetail/related.php';
?>
<!-- END CONTENT -->
